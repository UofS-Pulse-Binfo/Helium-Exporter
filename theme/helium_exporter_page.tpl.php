...
<div id="helium-exporter-contariner" style="max-width: 900px">
  <div id="helium-exporter-header">  
    ...
    <div id="helium-exporter-help">
      <?php if ($help_url != '#') { ?>
        <a href="<?php print $help_url; ?>" target="_blank" alt="help" title="help"><img src="<?php print $path_module . '/theme/images/help.gif'; ?>" style="border: none;" height="25" width="25"></a>
      <?php } ?>
      &nbsp;
    </div>
